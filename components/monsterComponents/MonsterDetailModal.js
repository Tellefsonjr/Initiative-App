      ...
      <Modal
        ...
        <View style={ styles.modalHeader }>
          <View style={{ flexDirection: 'row', alignItems: 'center'}}>
            ...
            />
            <Text style={{ fontSize: 26, fontWeight: 'bold', marginRight: 5,}}> { props.monster.name } </Text>
            <Text style={{ fontSize: 20, color: 'grey', fontStyle: 'italic'}}> { props.monster.type } </Text>
            <Text style={{ fontSize: 20, color: 'grey', fontStyle: 'italic'}}> CR { props.monster.cr } </Text>
          </View>
          <View style={{ flexDirection: 'row', }}>
            ...
            <View style={ styles.headerStats }>
              ...
              <Text style={{ fontSize: 18 }}> Initiative: +{ props.monster.initiativeBonus } </Text>
            </View>
            <View style={ styles.headerStats }>
