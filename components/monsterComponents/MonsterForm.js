...
const MonsterForm = props => {
  ...
  const fields = [
    ...
    {label: 'Select Type', type: 'select', name: 'type', default: 'default', data: ['Absysal', 'Celestial', 'Bard', 'Blood Hunter', 'Cleric', 'Druid', 'Fighter', 'Monk', 'Paladin', 'Ranger', 'Rogue', 'Sorcerer', 'Warlock', 'Wizard', 'Other'], value: 'Please Select'},
